...
# Loading data
df1 = pd.read_csv("..\Data\All_India_Price.csv")
...
# print(X.columns)
# print(np.where(X.columns=="Yemlur,Bangalore")[0][0])
...
# Testing the model
print(predict_price('Action Area I,Kolkata',1000, 2, 2))
print(predict_price('Worli,Mumbai',1000, 3, 3))
print(predict_price('Zirakpur,Chandigarh',1000, 2, 2))
print(predict_price('Zingabai Takli,Nagpur',1000, 3, 3))

# Export the tested model to a pickle file and also the excel sheet.
with open('All_India.pickle','wb') as f:
